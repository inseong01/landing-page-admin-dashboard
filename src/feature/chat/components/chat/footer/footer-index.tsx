...
export default function ChatFooter({
  ...
  return (
    <div className="relative flex flex-col p-8 pt-3 pb-3">
      <div
        className={`chatBoxBorder flex justify-between overflow-hidden p-1.5 ${!isOpponentOnline ? "cursor-not-allowed bg-[#f5f5f5]" : ""} dark:bg-[#4D4D4D]`}
      >
        <input
          type="text"
        ...
        <button
          type="button"
          role="button"
          className="flex items-center justify-center rounded-xl bg-[#336cb5] p-1 pr-[12px] pl-[14px] text-white hover:bg-[#2a5896] disabled:pointer-events-none disabled:bg-[#757575] dark:bg-[#4A6F9E] dark:hover:bg-[#376095]"
