...
export default function ChatHeader({
  ...
  return (
    <div className="relative box-border flex min-h-[71px] w-full items-center justify-center border-b-[1px] border-[#ddd] p-4 dark:border-[#4D4D4D]">
      {/* 뒤로가기 아이콘 */}
      {enableBack && (
        <button
      ...
      <div className="flex cursor-default flex-col items-center gap-1.5">
        <span className="max-w-[200px] overflow-x-hidden text-center text-base leading-4 text-ellipsis whitespace-nowrap dark:text-white">
          {chatroomTitle}
        </span>
        <span className="text-xs leading-3 text-[#7C7C7C] dark:text-[#A7A7A7]">
