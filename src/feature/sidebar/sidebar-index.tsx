...
import ICON_SIDEBAR_LIGHT from "./../../assets/icon-sidebar-white.svg";
...
function AdminContent({ onClick }: { onClick: () => void }) {
  ...
  const loginText = isLogin ? "00님 환영합니다." : "로그인이 필요합니다.";
                ...
                {isExpanded && (
                  <ul>
                    <CategoryList
                      listTitle="랜딩 페이지"
                      icon_alt="랜딩 페이지 파비콘"
                      icon_src={ICON_LANDING_PAGE_LIGHT}
